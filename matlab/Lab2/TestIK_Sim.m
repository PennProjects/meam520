...
% ABBY-JAL TEST
% Test 1
%T0e = [ [ -0.0024   -0.0339   -0.9994  -74.7991]; [0.9975   -0.0707    0.0000    0.0001]; [-0.0707   -0.9969    0.0339  411.7560]; [ 0         0         0    1.0000]];

% Test 2
%T0e = [ -0.9976   -0.0000    0.0696   17.4768; 0.0000   -1.0000    0.0000    0.0000; 0.0696    0.0000    0.9976  476.9786; 0         0         0    1.0000];

% Test 3
%T0e = [   0.1569    0.0004    0.9876  116.0455;    0.0001   -1.0000    0.0004    0.0493;    0.9876   -0.0000   -0.1569   89.0771;         0         0         0    1.0000];

%Test 4
T0e = [   0.9103   -0.0000    0.4139  238.6753 ; 0.0000   -1.0000   -0.0000   -0.0003;0.4139    0.0000   -0.9103  -95.8825; 0         0         0    1.0000];
